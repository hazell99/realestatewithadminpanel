...
const PropertyDetail = () => {
  ...
  useEffect(() => {
    ...
    setFormattedPrice(formatPrice(updatePrice));
  }, [updatePrice]);
          ...
          <div className={classes.leftRight}>
            <div className={classes.left}>
              ...
              <div className={classes.boxes}>
                Type:{" "}
                <span>{`${propertyDetail?.type
                  .charAt(0)
                  .toUpperCase()}${propertyDetail?.type.slice(1)}`}</span>
              </div>
              <div className={classes.boxes}>
            ...
            <div className={classes.right}>
              <div className={classes.map} style={{gap:"10px"}} >
                <div className={classes.borders}>
                <span style={{fontSize:"1.5rem",color:"orange"}}>Location :</span>
                <span style={{fontSize:"1.5rem",color:"black"}}>{propertyDetail?.location}</span>
